    ...
    <div class="page">
        ...
        <div class="main-sidebar main-sidebar-sticky side-menu">
            ...
            <div class="main-sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html"><span class="shape1"></span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">ارزهای رمزنگاری شده</span><i
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">تجارت الکترونیک</span><i
                                class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="widgets.html"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">ابزارک ها</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                class="shape2"></span><i class="ti-email sidemenu-icon"></i><span
                                class="sidemenu-label">نامه </span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">برنامه ها</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">نمادها</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">نقشه ها </span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">جداول</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">عناصر</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">رابط کاربری پیشرفته</span><i
                                class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">فرم </span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">نمودارها </span><span
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label ">صفحات</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">خدمات رفاهی</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link with-sub" href="#"><span class="shape1"></span><span
                                ...
                                class="sidemenu-label">صفحات سفارشی</span><i class="angle fe fe-chevron-left"></i></a>
                        <ul class="nav-sub">
                            <li class="nav-sub-item">
            ...
            <div class="container-fluid">
                ...
                <div class="main-header-right">
                    ...
                    <div class="dropdown d-md-flex header-settings">
                        <a href="#" class="nav-link icon" data-toggle="sidebar-left"
        ...
        <div class="main-footer text-center">
            <div class="container">
                <div class="row row-sm">
                    <div class="col-md-12">
                        <span>کپی رایت © 1399 . طراحی شده توسط <a href="#">Themefix</a> کلیه حقوق محفوظ
                            است.</span>
                    </div>
                </div>
            </div>
        ...
        <div class="sidebar sidebar-left sidebar-animate">
            ...
            <div class="sidebar-body">
                ...
                <div class="d-flex p-3">
                    <label class="ckbox"><input checked="" type="checkbox"><span>با دوستان
                            بودن</span></label>
                    <span class="mr-auto">
                        <i class="fe fe-edit-2 text-primary mr-2" data-toggle="tooltip" title=""
                            data-placement="top" data-original-title="ویرایش کنید"></i>
